...
export class CargoStatusService {
    ...
    getCargoStatusesWithOrdersData() {
        return [
            {
                id: '1000',
                code: 'f230fh0g3',
    ...
    getCargoStatusesMini() {
        return Promise.resolve(this.getCargoStatusesData().slice(0, 5));
    }

    getCargoStatusesSmall() {
        return Promise.resolve(this.getCargoStatusesData().slice(0, 7));
    }

    getCargoStatuses() {
        return Promise.resolve(this.getCargoStatusesData());
    }

    getCargoStatusesWithOrdersSmall() {
        return Promise.resolve(this.getCargoStatusesWithOrdersData().slice(0, 10));
    }

    getCargoStatusesWithOrders() {
        return Promise.resolve(this.getCargoStatusesWithOrdersData());
    }
};
