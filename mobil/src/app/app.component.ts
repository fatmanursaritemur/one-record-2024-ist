...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.router.events.subscribe(e => {
      if (e instanceof NavigationEnd) {
        ...
        } else if (this.router.url === '/company-operation') {
          this.items = [
            {
              label: 'TGS Operation',
        ...
        } else if (this.router.url === '/company-qrs-operation') {
          this.items = [
            {
              label: 'QRS Operation',
              routerLink: 'company-qrs-operation',
              icon: 'pi pi-align-justify',
            },
          ];
        } else if (this.router.url === '/company-qws-operation') {
          this.items = [
            {
              label: 'QWS Operation',
              routerLink: 'company-qws-operation',
              icon: 'pi pi-align-justify',
            },
          ];
        } else if (this.router.url === '/company-cargo-operation') {
          this.items = [
            {
              label: 'Turkish Cargo',
              routerLink: 'company-cargo-operation',
              icon: 'pi pi-align-justify',
            },
          ];
        }
  ...
  checkCompanyOperation() {
    return this.router.url === '/company-operation'
  }

  checkQrsCompanyOperation() {
    return this.router.url === '/company-qrs-operation'
  }

  checkQwsCompanyOperation() {
    return this.router.url === '/company-qws-operation'
  }

  checkCargoCompanyOperation() {
    return this.router.url === '/company-cargo-operation'
  }
