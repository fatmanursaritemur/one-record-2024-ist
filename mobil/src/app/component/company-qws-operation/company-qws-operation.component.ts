...
@Component({
  selector: 'app-company-qws-operation',
  templateUrl: './company-qws-operation.component.html',
  styleUrls: ['./company-qws-operation.component.scss']
})
export class CompanyQwsOperationComponent implements OnInit {
